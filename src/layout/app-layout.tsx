...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'administrator', 'trader', 'analyst', 'customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Analysts', path: '/analysts', entity: 'analyst', service: AccessServiceEnum.PROJECT, icon: FiBarChart2 },
    { name: 'Markets', path: '/markets', entity: 'market', service: AccessServiceEnum.PROJECT, icon: FiShoppingBag },
    { name: 'Owners', path: '/owners', entity: 'owner', service: AccessServiceEnum.PROJECT, icon: FiBriefcase },
    { name: 'Trades', path: '/trades', entity: 'trade', service: AccessServiceEnum.PROJECT, icon: FiTrendingUp },
