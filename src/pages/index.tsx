  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to mexc - Your Ultimate Destination for Building and Trading in the Market Exchange Universe."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxleGNoYW5nZXxlbnwwfHx8fDE2OTUzNTQ0NzB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to mexc - Your Ultimate Destination for Building and Trading in the Market Exchange Universe.`}
            </Text>
            <Box
