...
import { TradeListPage } from 'pages/trades';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  label="Opening Hours"
                  text={
                    data?.opening_hours ? format(parseISO(data?.opening_hours as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
                ...
                <FormListItem
                  label="Closing Hours"
                  text={
                    data?.closing_hours ? format(parseISO(data?.closing_hours as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
