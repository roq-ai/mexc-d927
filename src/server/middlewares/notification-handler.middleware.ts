...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'trade_executed.create': { roles: ['owner', 'administrator', 'analyst'], key: 'trade', tenantPath: [], userPath: [] },
  'report_generated.create': {
    roles: ['owner', 'administrator', 'trader'],
    key: 'report',
    tenantPath: [],
    userPath: [],
  },
  'policy_implemented.create': { roles: ['owner', 'trader', 'analyst'], key: 'policy', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['owner', 'administrator', 'trader', 'analyst', 'customer'];
